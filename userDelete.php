...
// if list was deleted successfully. Redirect to user page;
...
// If doesn't contain userID parameter. show error message.
echo "something went wrong, doesn't contain userID parameter";
exit();
    }
}
?>
...
<div class = "row border rounded-5 p-3 bg-white shadow-lg box-area">
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <p class = "text">Are you sure you want to delete this user?</p>
        <input type="submit" value="Yes" class="btn btn-primary">
        <a href="userEdit.php" class="btn btn-secondary">No</a>
    </form>
</div>
</div>
